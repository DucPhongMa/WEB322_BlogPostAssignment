...
module.exports.initialize = function () {
    return new Promise(function (resolve, reject) {
        let db = mongoose.createConnection("mongodb+srv://mphong-duc:phongma123@senecaweb.owdod.mongodb.net/SenecaWeb?retryWrites=true&w=majority");
       ...
       if(userData.password !== userData.password2){
            ...
            bcrypt.genSalt(10).then((salt) => {
                bcrypt.hash(userData.password, salt).then(hash=>{ 
                    ...
                    newUser.save((err) => {
                        if(err){                    
                            if(err.code == 11000){ // check duplicate
